...
train_config = {'num_iterations': 500000,  # number of iterations
                ...
                'sample_every': 20000,  # Generate samples every N steps
                'sample_length': 1023,  # Sample this many tokens
                'sample_num': 10,  # Generate this many samples
                'save_every': 20000,  # Write a checkpoint every N steps
                }
